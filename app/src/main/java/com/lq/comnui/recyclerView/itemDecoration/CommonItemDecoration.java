package com.lq.comnui.recyclerView.itemDecoration;
...
//    public CommonItemDecoration(Context context int horizontal, int horizontalSpace, int verticalSpace) {
